...
```bash
# 1. Fork on GitHub: https://github.com/Soundararajan102/Brolier-360 → Fork
# 2. Clone your fork
...
```bash
git remote add upstream https://github.com/Soundararajan102/Brolier-360.git  # once
git fetch upstream
git checkout main
...
[bug report](https://github.com/Soundararajan102/Brolier-360/issues/new?template=bug_report.yml)
...
- Rebrand. The "CRM Template for WhatsApp" name, favicon, and
  `durocrm.com` URL belong to the upstream project; please swap them
