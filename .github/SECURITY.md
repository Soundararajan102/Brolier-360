...
- [GitHub Security Advisories](https://github.com/Soundararajan102/Brolier-360/security/advisories/new)
...
In scope:
- Anything in this repository (`Soundararajan102/Brolier-360`), including webhook and auth
