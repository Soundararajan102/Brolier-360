...
//
// Why the `durocrm_live_` prefix
//   - Self-identifying: a leaked string is instantly recognisable as
//     a Duro CRM key (handy for secret-scanners like GitGuardian).
//   - Forward-compatible: leaves room for a `durocrm_test_` variant if
...
export const API_KEY_PREFIX = 'durocrm_live_';
