...
//
// Every delivery carries an `X-DuroCRM-Signature` header so receivers
// can verify the request really came from Duro CRM and wasn't tampered
// with or replayed. The scheme is Stripe-style:
//
//   X-DuroCRM-Signature: t=<unix_seconds>,v1=<hex HMAC-SHA256>
//
...
/**
 * Build the `X-DuroCRM-Signature` header value for `rawBody`, signed
...
/**
 * Verify a signature header. Exposed so a Duro CRM-to-durocrm integration
